    ...
    <main className="max-w-4xl mx-auto px-6">
      ...
      <section className="min-h-[85vh] flex flex-col md:flex-row items-center gap-12 py-20">
        ...
        <div className="flex-1">
          ...
          <p className="mt-8 text-lg text-neutral-400 max-w-xl">
            Autoimmune disease. Crippling anxiety. Depression. Poor self-image. I climbed out of all, by
      ...
      <section id="about" className="py-24">
        ...
        <div className="space-y-5 text-lg text-neutral-300 leading-relaxed max-w-2xl">
          <p>
            ...
            24+ kgs of muscle in two and a half years. At 20, I was diagnosed with ulcerative colitis —
          ...
          <p>
            ...
            to do the work everyday, and it was difficult. Slowly, over the months and years, things started to change,
            my anxiety improved, depression lifted, and I regained 10+ kgs of muscle.
          </p>
          <p>
        ...
        <div className="space-y-8 max-w-2xl">
          <div>
            ...
            <p className="text-neutral-400 leading-relaxed">
              I started doing Calisthencis in 2017. Alongside I was curious to learn how to gain strength and hypertrophy,
          ...
          <div>
            ...
            <p className="text-neutral-400 leading-relaxed">
              ...
              I was very keen on learning how to make the brain healthier and how one can increase his own (fluid) intelligence. It found out that doing regular aerobic training
              was one of the very few ways in which you can objectively increase your intelligence, althought not that much. This is what got me started doing regular running sessions ever since.
              Plus, the fact that aerobic training induces growth of new capilaries and nerve cells in the brain sounds really cool, at least to me.
            </p>
          </div>
          <div>
            ...
            <p className="text-neutral-400 leading-relaxed">
              ...
              There was a period of a few years where my body & mind were under serious stress. I was drowning in fear how my health is declining and whether I would be able to live
          ...
          <div>
            ...
            <p className="text-neutral-400 leading-relaxed">
              ...
              I have always wanted to learn what differentiates the champions from all the rest. That is how I got learning about peak performance - the science on how to perform at your best,
              physically or mentally. Learning how to ramp up my focus, memory, and cognition have been very helpful in my university years when I had to cram for an exam, or wanted to learn a new
              subject faster.
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <p className="text-neutral-400 leading-relaxed">
              ...
              I see potential in each of us to achieve what they want, I am here to tell you just that. You are more than your thoughts and the feelings you are experiencing. You can change, and
          ...
          <div>
            ...
            <p className="text-neutral-400 leading-relaxed">
              ...
              to learn more about how the brain works and what consciousness is, and how it comes to be. Since then I have been experimenting with myself with meditation and nootropic substances like Alpha GPC, Lion's mane, Bacopa, etc. (but no hard drugs, I'm off that),
      ...
      <section id="achievements" className="py-24">
        ...
        <ul className="space-y-3 text-neutral-300 max-w-2xl list-disc list-outside pl-6 marker:text-red-400">
          <li>Gained 24+ kgs muscle mass in 2.5 years in high school. 2017 - 2020.</li>
          <li>Regained 10+ kgs muscle mass in 3 years with an active autoimmune disease. 2022 - 2025</li>
          <li>Improved autoimmune disease condition with altering exercise, nutrition, rest, and mindset in 1 year time. 2025 - 2026 </li>
          <li>Recovered from crippling anxiety on hour-to-hour basis in 2 yearstime. 2024 - 2026.</li>
          <li>Recovered completely from moderete depression in 6 months. Dec 2025 - May 2026.</li>
          <li>Awared Junior Blackbelt in Taekwondo at age 10.</li>
          <li>Held multiple European region records in a video game (World of Tanks). 2017 - 2022.</li>
          <li>In Calisthenics, full planche hold 4+ seconds. Apr 2022.</li>
          <li>In Calisthenics, front lever hold 19+ seconds. Dec 2025.</li>
        </ul>
      </section>
      ...
      <section id="contributions" className="py-24">
        ...
        <ul className="space-y-3 text-neutral-300 max-w-2xl list-disc list-outside pl-6 marker:text-red-400">
          ...
          <li>
            <strong className="text-neutral-100">Academic:</strong> As a Teaching Assistant in TU Eindhoven, I tutored ~10 students in Calculus and helped ~350 students with Computer Networks & Security by grading and providing feedback on their work.
          </li>
          <li>
            <strong className="text-neutral-100">Empowerment:</strong> Empowered ~100 people to change an existing habit or start a new one, by providing them with science-backed tools. (e.g., in training, morning practice, meditaion, sleep, stress management, mindset)
          </li>
        </ul>
      </section>
      ...
      <footer className="border-t border-neutral-800 py-10 text-sm text-neutral-500 text-center">
        © {new Date().getFullYear()} Misho. Built with Next.js.
      </footer>
    </main>
  );
}